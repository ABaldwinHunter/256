...
// });
  ...
  Mousetrap.bind('sup', function(){ newGame.moveLeft(); newGame.spawn(); newGame.updateBoard();});
  Mousetrap.bind('soup', function(){ newGame.moveLeft(); newGame.spawn(); newGame.updateBoard();});
});
